    ...
    <section class="section-details-content">
        <div class="container">
                    ...
                    <div class="card card-details">
                        ...
                        <div class="gallery">
                            <div class="xzoom-container">
                                ...
                                class="xzoom rounded mx-auto d-block" 
                                id="xzoom-default"
                        ...
                        <div class="features row">
                            ...
                            <div class="col-md-4 ">
                                <img src="{{url('frontend/images/ic_food.png')}}" 
                                alt="" 
                                class="features-image">
          ...
          <div class="join-container">
              ...
              @endauth
              @guest
              <a href="{{route('login')}}" class="btn btn-block btn-join-now mt-3 py-2  col-12 col-lg-12">
