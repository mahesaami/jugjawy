        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 pl-lg-0">
                    <div class="card card-details">
                        ...
                        <div class="member mt-3">
                            ...
                            <p class="disclaimer mb-0">You are only able to invite person who has registered in Al Jugjawy</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                  ...
                  <tr>
                      ...
                      <td width="50%" class="text_right text-discount">
              ...
              <p class="payment-instruction">
                  Please complete the payment before join the trip
              </p>
              <div class="bank">
                ...
                <div class="join-container">
                  <a href="{{route('checkout-success', $item->id)}}" class="btn btn-block btn-join-now mt-1 py-2 col-12 col-lg-12">
                      Transfer
                  </a>
              </div>
